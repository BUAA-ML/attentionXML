...
if [ ! -f data/$1/train_texts.npy ]; then
  python preprocess.py $TRAIN_TEXT --label-path ../datasets/AAPD/train_labels.txt --vocab-path ../datasets/AAPD/vocab.npy #--emb-path data/$1/emb_init.npy --w2v-model data/glove.840B.300d.gensim
fi
