...
if [ ! -f data/$1/train_texts.npy ]; then
  python preprocess.py $TRAIN_TEXT --label-path ../../datasets/multiLabel_text_classification/AAPD/train_labels.txt --vocab-path ../../datasets/multiLabel_text_classification/AAPD/vocab.npy --w2v-model ../../datasets/word_embedding/glove.840B.300d.gensim #--emb-path data/$1/emb_init.npy
fi
